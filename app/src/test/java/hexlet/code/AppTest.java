...
public class AppTest {
    ...
    public static void before() throws Exception {
        data1 = getData("src/test/resources/files/introductoryYaml.yml");
        data2 = getData("src/test/resources/files/introductoryJson.json");
    }

    @Test
    public void testGenerateStylishFormat() throws IOException {
        String expectedOutput = readFile("src/test/resources/resultFiles/testStylish.txt");
    ...
    public void testGenerateJsonFormat() throws IOException {
        String expectedOutput = readFile("src/test/resources/resultFiles/testJson.json");
    ...
    public void testGeneratePlainFormat() throws IOException {
        String expectedOutput = readFile("src/test/resources/resultFiles/testPlain.txt");
